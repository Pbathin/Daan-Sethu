...
export default function PopHouseholdItemCard({ item }) {
      ...
      >
        <View style={styles.modalContainer}>
          ...
          <View style={styles.subcont}>
            ...
            <Text style={styles.description}> Category: {item.category},        Condition: {item.condition},        Quantity: {item.quantity}</Text>
            <Text style={styles.info}> Address: {item.address}</Text>
            <Text style={styles.info}> City: {item.city},        Pin code: {item.pinCode}</Text>
            <Text style={styles.info}> Landmark: {item.landmark}</Text>
          </View>
        </View>
        <MapView
          style={styles.map}
