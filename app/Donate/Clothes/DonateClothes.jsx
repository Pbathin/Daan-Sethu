...
export default function DonateClothes() {
    ...
    const saveClothesList = async (imageUrl) => {
        await setDoc(doc(db, 'ClothesList', Date.now().toString()), {
    ...
    return (
        <ScrollView style={{ padding: 10 }}>
            <Text style={{ fontFamily: 'outfit', color: "gray" }}>
                Fill all the details to donate clothes
            </Text>
            ...
            <View>
                <View style={styles.TxtIp}>
                    <Picker
                        selectedValue={clothesType}
                        onValueChange={clothesType => setClothesType(clothesType)}>
                ...
                <TextInput placeholder='Size (e.g., S, M, L, XL)'
                ...
                <TextInput placeholder='Quantity'
                    ...
                    style={styles.TxtIp}
                />
                <TextInput placeholder='Condition (e.g., New, Gently Used)'
                ...
                <TouchableOpacity
                    disabled={loading}
                    style={styles.btn}
                    onPress={() => onDonateClothes()}>
                    {loading ? (
                        <ActivityIndicator size={'large'} color={'#fff'} />
                    ) : (
                        <Text style={styles.btnTxt}>Donate Clothes</Text>
                    )}
                </TouchableOpacity>
            </View>
